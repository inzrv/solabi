...
static_assert(solabi::kIsStatic<solabi::tuple_t<solabi::uint_t<256>, solabi::bool_t>>);
static_assert(solabi::kIsStatic<StaticRecord>);
static_assert(solabi::kIsStatic<NestedStaticRecord>);
static_assert(!solabi::kIsStatic<DynamicRecord>);
static_assert(!solabi::kIsStatic<NestedDynamicRecord>);
static_assert(!solabi::kIsStatic<DeepRecord>);
static_assert(solabi::kIsStatic<solabi::array_t<solabi::uint_t<256>, 3>>);
static_assert(!solabi::kIsStatic<solabi::array_t<solabi::string_t, 2>>);
static_assert(std::is_same_v<solabi::cpp_type<solabi::string_t>::type, std::string>);
static_assert(std::is_same_v<solabi::cpp_type<solabi::address_t>::type, solabi::bytes>);
static_assert(std::is_same_v<solabi::cpp_type<solabi::bytes_fixed_t<3>>::type, solabi::bytes>);
static_assert(std::is_same_v<solabi::cpp_type<solabi::bytes_dyn_t>::type, solabi::bytes>);
